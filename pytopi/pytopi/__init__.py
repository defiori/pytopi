...
from .pytopi import (_TopiNetworkWithMessenger, _Messenger, 
_SharedArrayMut_bool, _SharedArrayMut_u8, _SharedArrayMut_u16, 
_SharedArrayMut_u32, _SharedArrayMut_u64, _SharedArrayMut_i8, 
_SharedArrayMut_i16, _SharedArrayMut_i32, _SharedArrayMut_i64, 
_SharedArrayMut_f32, _SharedArrayMut_f64)


class PyTopiNetwork():
    def __init__(self, self_id, node_configs, global_config=None):
        self._inner = _TopiNetworkWithMessenger(self_id, node_configs, global_config)
        self._messenger = Messenger(self._inner.messenger())

    def send(self, to, msg, metadata=None):
        self._messenger.send(to, msg, metadata)

    def recv(self):
        return self._messenger.recv()

    def try_recv(self):
        return self._messenger.try_recv()
